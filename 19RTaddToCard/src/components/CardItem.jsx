...
import { increasequantity, removeCard, dereasequantity } from '../features/ProductSlice';
        ...
        <>
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={() => dispatch(dereasequantity({ id: product.id }))}
                ...
                <button
                    ...
                    onClick={() => dispatch(removeCard({ id: product.id }))}
                >
                    Remove
                </button>
            </div>
