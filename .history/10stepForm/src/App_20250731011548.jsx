        ...
        <form>
          ...
          <div id="step-1" style={{ display: step1 ? "none" : "block" }}>
            ...
            <div className="btn-wrapper">
              <button onClick={(e) => e.preventDefault()} className="btn btn-next" onClick={onClickStep1}>Next</button>
            </div>
          </div>
          {/* Step 2 */}
          <div id="step-2" style={{ display: step2 ? "none" : "block" }}>
            ...
            <div className="btn-wrapper space-between">
              <button onClick={(e) => e.preventDefault()} className="btn btn-back" onClick={gobacktostep1}>Back</button>
              <button onClick={(e) => e.preventDefault()} className="btn btn-next" onClick={onClickStep2}>Next</button>
            </div>
          </div>
          {/* Step 3 */}
