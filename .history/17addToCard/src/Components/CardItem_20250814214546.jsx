...
function CardItem({ productinfo }) {
  ...
  return (
    <div className="flex items-center justify-between bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-200" id={productinfo.id}>
      {/* Left - Image + Name */}
      <div className="flex items-center gap-4">
        <img
          src={productinfo.imgsrc}
          alt={productinfo.name}
          className="w-16 object-cover rounded-lg border"
        />
        <div>
