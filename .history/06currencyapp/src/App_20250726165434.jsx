      ...
      <div className="w-full max-w-md mx-auto border border-gray-300 rounded-2xl p-6 backdrop-blur-md bg-white/20 shadow-2xl">
        ...
        >
          ...
          <div className="relative w-full h-0.5">
            <button
              type="button"
              className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-full bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 transition-all m-2.5 cursor-pointer"
              onClick={swap}
            >
              Swap
            </button>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-4 py-3 rounded-xl font-semibold transition-all cursor-pointer"
            onClick={convert}
          >
