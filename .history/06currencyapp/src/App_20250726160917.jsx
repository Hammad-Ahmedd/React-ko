      ...
      <div className="w-full max-w-md mx-auto border border-gray-300 rounded-2xl p-6 backdrop-blur-md bg-white/20 shadow-2xl">
        ...
        >
          ...
          <div className="relative w-full h-0.5">
            <button
              type="button"
              className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-full bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 transition-all m-2.5 cursor-p"
              onClick={swap}
            >
              Swap
            </button>
