...
export const ProductSlice = createSlice({
    ...
    reducers: {
        ...
        cardSwitcher: (state, action) => {
            state.cardSwitcher ? state.cardSwitcher = false : state.cardSwitcher = true
        }
    }
})

export const { addToCard, removeCard, increasequantity, dereasequantity, cardSwitcher } = ProductSlice.actions
