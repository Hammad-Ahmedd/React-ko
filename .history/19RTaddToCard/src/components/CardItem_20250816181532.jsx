            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <br />
                        <span className="text-gray-500 text-sm">Total= ${product.price * useselect.quantity}</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={() => useDispatch(increaseQuantity(useselect.id))}
                        className="w-8 h-8 flex items-center justify-center bg-gray-200 rounded hover:bg-gray-300 transition-colors duration-200"
                    >
                        +
                    </button>
                ...
                <button
                    ...
                    onClick={() => useDispatch(removeToCard(useselect.id))}
                >
                    Remove
                </button>
            </div>
